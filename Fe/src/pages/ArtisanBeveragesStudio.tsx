...
const ArtisanBeveragesStudio: React.FC = () => {
  ...
  // Load all media under sementara, then filter folder with spaces/parentheses reliably
  const allMedia = import.meta.glob('../assets/sementara/**/*', { eager: true, as: 'url' }) as Record<string, string>;
  const targetDir = '/Artisan Bevarages Studio/';
    ...
    <div style={styles.page}>
      ...
      <main style={styles.container}>
        <section style={styles.hero}>
          <h1 style={styles.title}>Artisan Beverages Studio</h1>
        ...
        <section style={styles.section}>
          <p style={styles.paragraph}>Artisan Beverages Studio merupakan sebuah cafe untuk tempat belajar anak - anak di Metland School.</p>
          <br />
          <p style={styles.paragraph}>Metland School sendiri menerapkan TeFa. Teaching factory merupakan pembelajaran produksi yang merupakan framework bagi peserta didik bagi pendidikan vokasi di masa depan.</p>
          <br />
          <p style={styles.paragraph}>Memiliki potensi menjadi pendekatan belajar yang lebih efisien dan efektif jika menjadi bagian dari konteks pendidikan, juga menyiapkan lulusan SMK yang adaptable terhadap perubahan dunia untuk menjadi lulusan yang dapat bekerja, melanjutkan, dan berwirausaha.</p>
        </section>
      </main>
      <Footer />
    </div>
...
export default ArtisanBeveragesStudio;
