...
const PilloKaliana: React.FC = () => {
  ...
  // Some bundlers/glob matchers can be sensitive to parentheses/spaces in folder names.
  // Use a wide glob and filter paths that contain the specific folder name instead.
  const allMedia = import.meta.glob('../assets/sementara/**/*', { eager: true, as: 'url' }) as Record<string, string>;
  const targetDir = '/Pillo ( Perfection In Life and Love )/';
  ...
  const description = 'Pillo merupakan education hotel dengan 13 kamar yang digunakan untuk kegiatan TEFA ( Teaching Factory ) siswa SMK PARIWISATA METLAND sebagai metode pembelajaran real industry. Meskipun education hotel namun hotel ini dipasarkan secara masal. Pillo berada dilantai 26 pada tower Aster Apartement Kaliana- Bogor';
    ...
    <div style={styles.page}>
      ...
      <main style={styles.container}>
        <section style={styles.hero}>
          <h1 style={styles.title}>Tentang Pillo</h1>
          <p style={styles.subtitle}>( Perfection In Life and Love )</p>
        </section>
